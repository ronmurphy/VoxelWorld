...
need to look in to when a tree is removed sometimes, dirt blocks will spawn at the targeting green block, definetly a out of place code issue.  does not always happen.  

latest code addition > ToolBenchSystem.js > see toolbench.md 