...
export class BiomeWorldGen {
    ...
    initializeBiomes() {
        this.biomes = {
            ...
            // 🌊 NEW: Ocean/Lake biome for deep water areas
            ocean: {
                name: 'Ocean',
                color: 0x0066CC,
                minHeight: -2,  // 🌊 NEGATIVE HEIGHT: Creates deep water basins (y=-2 to y=1)
                maxHeight: 1,   // 🌊 Seafloor at y=0-1, water fills to y=4 (4-6 blocks deep!)
                surfaceBlock: 'sand',  // Sandy ocean floor
                subBlock: 'stone',
                mapColor: '#0066CC',
                heightColorRange: { min: 0.6, max: 1.0 },
                shrubChance: 0.0,  // No shrubs underwater

                variants: ['deep_ocean', 'shallow_ocean', 'lake'],
                transitionZone: 'coastline',
                specialFeatures: ['underwater_caves', 'reefs', 'trenches'],
                treeDistribution: { min: 0.0, max: 0.0, clusters: false },
